import { useTransactions, useCategories, useFinanceSummary } from "@/hooks/useFinanceData";
...
export default function StatsPage() {
  ...
  const savingRate = summary.totalIncome > 0 ? (((summary.available) / summary.totalIncome) * 100).toFixed(1) : "0";
    ...
    <div className="pb-24 animate-fade-in">
      ...
      <div className="px-5 grid grid-cols-2 gap-3 mb-5">
        ...
        <div className="glass-card p-4">
          ...
          <p className="text-xl font-semibold text-destructive font-mono">{formatShortCurrency(summary.fixedExpenses)}</p>
        </div>
      </div>
